...
const content = {
  ru: {
    ...
    sections: [
      ...
      {
        title: "7. Контакты",
        body: "Оператор сервиса — Axioma8. По вопросам условий использования: ",
  ...
  en: {
    ...
    sections: [
      ...
      {
        title: "7. Contact",
        body: "Service operator: Axioma8. For questions about these terms: ",
  ...
  ko: {
    ...
    sections: [
      ...
      { title: "7. 연락처", body: "서비스 운영: Axioma8. 약관 관련 문의: ", contactLink: "연락처 페이지" },
    ],
    back: "홈으로",
    privacy: "개인정보처리방침",
  },
  es: {
    ...
    sections: [
      ...
      { title: "7. Contacto", body: "Operador del servicio: Axioma8. Para consultas sobre estos términos: ", contactLink: "página de contacto" },
    ],
