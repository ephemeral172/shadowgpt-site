  ...
  return (
    <section className="relative py-32 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="grid grid-cols-4 gap-4 p-6 border-b border-gray-200 dark:border-white/5 text-[11px] tracking-[0.15em] uppercase text-gray-400 dark:text-white/25 font-light">
            {tx.cols.map((col, i) => (
          ...
          {competitors.map((comp, i) => (
            ...
            >
              <span className="text-sm text-gray-500 dark:text-white/30 font-light">{comp.name}</span>
              <span className="text-sm text-gray-400 dark:text-white/20 font-light">{lang === "en" ? comp.priceEn : comp.price}</span>
              <span className="text-sm text-gray-400 dark:text-white/20 font-light">{lang === "en" ? comp.setupEn : comp.setup}</span>
          ...
          >
            ...
            <span className="text-sm text-gray-600 dark:text-white/60 font-light">{lang === "en" ? shadowgpt.priceEn : shadowgpt.price}</span>
            <span className="text-sm text-gray-600 dark:text-white/60 font-light">{lang === "en" ? shadowgpt.setupEn : shadowgpt.setup}</span>
            <div className="flex justify-center">
              <Check className="w-4 h-4 text-gray-600 dark:text-white/60" strokeWidth={1.5} />
            </div>
          </motion.div>
        </motion.div>
      </div>
