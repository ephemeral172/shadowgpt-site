              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-white/45 font-light mb-3">{seg.range}</p>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <div className="w-1 h-1 rounded-full bg-gray-400 dark:bg-white/20" />
                        <span className="text-sm text-gray-600 dark:text-white/60 font-light">{seg.buyerLabel}: {seg.buyer}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-1 h-1 rounded-full bg-gray-500 dark:bg-white/30" />
                        <span className="text-sm text-gray-700 dark:text-white/75 font-light">{seg.pain}</span>
                      </div>
                    </div>
                  </div>
                </div>
